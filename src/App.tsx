...
function MainContent() {
  ...
  const fetchProducts = async () => {
    ...
    // Map camelCase if database uses snake_case, or just use as is if we map database to camelCase
    // For now assuming snake_case to camelCase mapping for wholesale_price
